...
Gdip_ImageSearch(pBitmapHaystack,pBitmapNeedle,ByRef Xout=0, ByRef Yout=0
...
,SearchDirection=1,Instances=1,LineDelim="`n",CoordDelim=",") {
    ...
    OutputCount := Gdip_MultiLockedBitsSearch(hStride,hScan,hWidth,hHeight
        ,nStride,nScan,nWidth,nHeight,Xout,Yout,OuterX1,OuterY1,OuterX2,OuterY2
...
Gdip_MultiLockedBitsSearch(hStride,hScan,hWidth,hHeight,nStride,nScan,nWidth,nHeight
    ,ByRef Xout=0, ByRef Yout=0,OuterX1=0,OuterY1=0,OuterX2=0,OuterY2=0,Variation=0
